...
func SetupMongoDBClusterWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr).For(&mongodbv1.MongoDBCluster{}).
...
// +kubebuilder:webhook:path=/mutate-mongodb-akleymk4-com-v1-mongodbcluster,mutating=true,failurePolicy=fail,sideEffects=None,groups=mongodb.akleymk4.com,resources=mongodbclusters,verbs=create;update,versions=v1,name=mmongodbcluster-v1.kb.io,admissionReviewVersions=v1
...
func (d *MongoDBClusterCustomDefaulter) Default(_ context.Context, obj runtime.Object) error {
	mongodbcluster, ok := obj.(*mongodbv1.MongoDBCluster)
...
// +kubebuilder:webhook:path=/validate-mongodb-akleymk4-com-v1-mongodbcluster,mutating=false,failurePolicy=fail,sideEffects=None,groups=mongodb.akleymk4.com,resources=mongodbclusters,verbs=create;update,versions=v1,name=vmongodbcluster-v1.kb.io,admissionReviewVersions=v1
...
func (v *MongoDBClusterCustomValidator) ValidateUpdate(_ context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	mongodbcluster, ok := newObj.(*mongodbv1.MongoDBCluster)
	if !ok {
